...
public class ObjectDestructuringPattern : DestructuringPattern {
    public List<ObjectDestructuringPatternField> Fields;

    public ObjectDestructuringPattern(List<ObjectDestructuringPatternField> fields, TypeExpression type) : base(type) {
        Fields = fields;
    }
}

public class ObjectDestructuringPatternField : Node {
    public Expression Key;
    /// <summary>Optional pattern.</summary>
    public DestructuringPattern Subpattern;

    public ObjectDestructuringPatternField(Expression key, DestructuringPattern subpattern) : base() {
        Key = key;
...
public class ArrayInitializer : Expression {
    /// <summary>List of <c>Expression</c> and <c>Spread</c>.</summary>
...
public class IfStatement : Statement {
    /// <summary>
    /// Test. <c>Expression</c> or <c>SimpleVariableDeclaration</c>.
    /// </summary>
    public Node Test;
    public Statement Consequent;
    public Statement Alternative;

    public IfStatement(Node test, Statement consequent, Statement alternative) : base() {
        Test = test;
        Consequent = consequent;
        Alternative = alternative;
    }
...
public class WhileStatement : Statement {
    ...
    public WhileStatement(Node test, Statement body) : base() {
        Test = test;
        Body = body;
    }
}
